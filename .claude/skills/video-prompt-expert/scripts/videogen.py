...
SOURCE = "视频生成提示词专家-SkillHub"
VIDEO_SOURCE = "视频生成提示词专家-视频生成-SkillHub"
...
def get_api_key(cli_key=None):
    """Get API key: CLI arg > env var > qoder config file."""
    if cli_key:
        return cli_key
...
Examples:
  ...
  python3 videogen.py "ignored" --task-id vg_abc123def456
    ...
    parser.add_argument("--api-key", help="API Key (前往 https://redfox.hk/settings/api-keys?source=skillhub 注册获取)")
