...
- `搞笑赛道/` —— 搞笑剧情向，女主"搞笑女"收敛为 3 主：S1 离谱行为 + S2 脑回路清奇 + S5 社会现象演绎（第一人称演现象→共鸣→打脸爽点→教育，详见 `搞笑赛道/搞笑赛道定位手册.md`）
- `短剧赛道/` —— 童年往事切片剧：基于真实童年/少年经历改编，主角像电视剧主角一样有"我从小到大的那些事"主线，切片日更追更养粉，分阶段推进（详见 `童年往事切片剧-定位手册.md`）
